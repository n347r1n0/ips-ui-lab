    ...
    <div className="space-y-0">
      ...
      <FloatingChipWheel
        ...
        /* 📐 ГЕОМЕТРИЯ / ВИЗУАЛ ОБЩИЙ */
         size={240}                  // ⌀ фишки, px (дефолт 230)
         radius={103}                 // радиус дорожки иконок, px (дефолт 99)
        ...
        chipSize={17}              // размер «слота» иконки, px (дефолт 25)
         labelOffset={{ x: -12, y: -20 }} // смещение подписи (дефолт x: -12, y: -18)
...
//        sound={{ src: '/sounds/snap-click.mp3', volume: 0.05 }}
        ...
        skinProps={{
          ...
          centerInsetLight: 0.16,   // 0..1 — тонкий «ободок» изнутри
          ...
          rimWidth: 45,             // толщина цветного обода (кольца) в px
